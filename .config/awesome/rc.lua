...
-- beautiful init
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/outputnoise/theme.lua")
...
memwidget = lain.widgets.mem({
    settings = function()
        widget:set_markup(markup(gray, " Mem: ") .. mem_now.used .. " M ")
    end
})
...
fshomeupd = lain.widgets.fs({
	...
	widget:set_markup(markup(gray, partition) .. fs_now.available .. " % ")
    end
})
